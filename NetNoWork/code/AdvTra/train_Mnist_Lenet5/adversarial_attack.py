'''自建包'''
import _YSZ_ as ysz
from _YSZ_ import Models, Optimizer, Data_Reader, _Base_ as base
...
'''加载测试数据'''
test_dataset = ysz.Data_Reader.Mnist.Mnist_dataset().get_test_dataset()
...
#modelpath='./train5_AdvT_InputZero2D.pkl'
# modelpath='./train5_AdvT_InputZero2D_wd.pkl'
#modelpath='./train3_AdvT.pkl'

net = ysz.Models.LeNet5.Lenet5()
